	...
	*input = templateRegex.ReplaceAllStringFunc(*input, func(s string) string {
		...
		case "arguments":
			...
			variable := &resolve.ContextVariable{
				Path:      variablePath,
				Generated: v.Operation.VariableValueIsGenerated(value.Ref),
			}
...
type FetchConfiguration struct {
	...
	RewriteVariableFunc  func(*resolve.Context, []byte, jsonparser.ValueType) ([]byte, jsonparser.ValueType, error)
	Variables            resolve.Variables
